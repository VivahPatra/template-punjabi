...
export const weddingData: WeddingConfig = {
  ...
  events: [
    { id: 'engagement', name: 'Engagement', emoji: '💍', date: 'December 16, 2026', time: '6:00 PM', venue: 'The Garden Terrace', venueAddress: '12 Rosewood Lane, Delhi', image: '/assets/events/engagement.webp', color: '#c8922a', description: 'Rings, promises and the beginning of forever.' },
    { id: 'mehendi', name: 'Mehendi', emoji: '🌿', date: 'December 17, 2026', time: '4:00 PM', venue: 'The Garden Terrace', venueAddress: '12 Rosewood Lane, Delhi', image: '/assets/events/mehendi.webp', color: '#1a6b44', description: 'Henna, laughter and the fragrance of mogra.' },
    ...
    { id: 'sangeet', name: 'Sangeet', emoji: '🎶', date: 'December 18, 2026', time: '7:00 PM', venue: 'The Grand Ballroom', venueAddress: 'Hotel Imperial, Delhi', image: '/assets/events/sangeet.webp', color: '#7b5ea7', description: 'Dance, music and a night full of stars.' },
    { id: 'wedding', name: 'Wedding', emoji: '💍', date: 'December 20, 2026', time: '10:00 AM', venue: 'Shri Sai Mandir Banquet', venueAddress: 'Temple Road, Connaught Place, Delhi', image: '/assets/events/wedding.webp', color: '#c8922a', description: 'Seven vows, one forever.' },
    { id: 'reception', name: 'Reception', emoji: '🥂', date: 'December 20, 2026', time: '7:00 PM', venue: 'The Grand Ballroom', venueAddress: 'Hotel Imperial, Delhi', image: '/assets/events/reception.webp', color: '#8b1a1a', description: 'Dinner, dancing and a night to remember.' },
  ],
