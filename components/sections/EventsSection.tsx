  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-3">
        <EditableText field="name" index={eventIndex} arrayField="events" tag="p" className="font-display tracking-wide glow-text" style={{ color: 'var(--color-text)', fontSize: isHero ? '1.25rem' : '1rem' }}>
          {event.name}
        </EditableText>
        <p
      ...
      >
        <EditableText field="venue" index={eventIndex} arrayField="events" tag="p" className="font-serif text-sm" style={{ color: 'var(--color-text)', opacity: 0.85 }}>
          {event.venue}
        </EditableText>
        <EditableText field="venueAddress" index={eventIndex} arrayField="events" tag="p" className="font-sans text-xs mt-1" style={{ color: 'var(--color-muted)', opacity: 0.7 }}>
          {event.venueAddress.split(',')[0]}
        </EditableText>
        {event.description && (
          <EditableText field="description" index={eventIndex} arrayField="events" tag="p" className="font-serif text-xs italic mt-1.5" style={{ color: 'var(--color-muted)', opacity: 0.65 }}>
            {event.description}
          </EditableText>
        )}
        <a
